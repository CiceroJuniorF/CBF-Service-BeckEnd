...
@NamedQueries({
	...
	@NamedQuery(name ="Ajudante.dtosfa", query = "SELECT new br.com.cbf.dto.AjudanteDTO(a.idUsuario,a.nome,a.email,a.salarioBase,a.salarioComissao,a.nivelAcesso) FROM Ajudante a")
})
@XmlRootElement
